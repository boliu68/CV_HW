...
public:
	...
	int norm_width;
	int norm_height;
	bool read_file(const string &folder); // read the image and light
    bool uniform_division(int k, int NSAMPLE); //sampling the light direction sphere and assign the nearest vertex
